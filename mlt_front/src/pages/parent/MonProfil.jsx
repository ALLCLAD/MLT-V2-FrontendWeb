...
import { Mail, User, Loader2, UserCircle, BadgeCheck, ShieldCheck, AtSign } from 'lucide-react';
                    ...
                    <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 md:left-12 md:translate-x-0 flex flex-col md:flex-row items-center gap-4">
                        ...
                        <div className="text-center md:text-left md:pb-1">
                            ...
                            <div className="flex items-center gap-1 justify-center md:justify-start">
                                ...
                                <p className="text-base-content/40 text-[10px] font-black uppercase tracking-widest">Compte Parent</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-md mx-auto space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 border-b border-base-200 pb-2 mb-4">
                                ...
                                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-base-content/40">Détails de sécurité</h3>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-4 p-4 bg-base-200/50 rounded-2xl border border-base-200 transition-all hover:border-blue-300/50">
                                    <div className="w-10 h-10 rounded-xl bg-base-100 flex items-center justify-center text-blue-600 shadow-sm">
                                        <AtSign size={18} />
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-[9px] font-black text-base-content/40 uppercase tracking-tighter">Identifiant</p>
                                        <p className="text-base-content font-bold">{profile.username}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4 p-4 bg-base-200/50 rounded-2xl border border-base-200 transition-all hover:border-blue-300/50">
                                    ...
                                    <div className="flex-1 overflow-hidden">
                                        <p className="text-[9px] font-black text-base-content/40 uppercase tracking-tighter">Email de contact</p>
                                ...
                                <div className="flex items-center gap-4 p-4 bg-base-200/50 rounded-2xl border border-base-200 transition-all hover:border-blue-300/50">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[9px] font-black text-base-content/40 uppercase tracking-tighter">Nom et Prénom</p>
                                        <p className="text-base-content font-bold">{profile.first_name} {profile.last_name}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
