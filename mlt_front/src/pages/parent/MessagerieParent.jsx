...
import { MessageSquare, Send, Heart, Loader2, ArrowLeft } from 'lucide-react';
...
const MessagerieParent = () => {
    ...
    // Chargement des contacts autorisés (enfants + profs des enfants)
    useEffect(() => {
